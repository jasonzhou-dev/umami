...
export const messages: Record<string, string> = {
  ...
  twoFactorSetupRequiredDescription:
    "message.two-factor-setup-required-description",
  ...
  twoFactorAdminGlobalDescription:
    "message.two-factor-admin-global-description",
  twoFactorRequireUserDescription:
    "message.two-factor-require-user-description",
  twoFactorRequireTeamDescription:
    "message.two-factor-require-team-description",
  ...
  twoFactorErrorInvalidPartialToken:
    "message.two-factor-error-invalid-partial-token",
  twoFactorErrorInvalidBackupCode:
    "message.two-factor-error-invalid-backup-code",
  ...
  twoFactorErrorDisableNotAllowed:
    "message.two-factor-error-disable-not-allowed",
  twoFactorErrorIncorrectPassword:
    "message.two-factor-error-incorrect-password",
